...
public class NoSqlTableApiTest {
  ...
  public void interfaceExistsAndExtendsCapability() throws Exception {
    Class<?> clazz = Class.forName("com.enrichmeai.test.core.cloud.capability.NoSqlTable");
  ...
  public void hasRequiredMethodSignatures() throws Exception {
    Class<?> c = Class.forName("com.enrichmeai.test.core.cloud.capability.NoSqlTable");
